...
# Problem Package Format Specification (0.9.0, Summer 2023)

This site contains a legacy specification for the (Kattis) Problem Package Format, arbitrarily versioned as `0.9.0`, roughly corresponding to the state of late Summer 2023.

The main reason for this page is an accessible legacy document in a repository aimed at developing more accessible documents with a reliable versioning system.

The legacy specification:

- [legacy problem package format specification 0.9.0, Summer 2023](problem_package_format.md)

Other versions are available in two places:
